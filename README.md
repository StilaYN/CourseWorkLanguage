...
**Цель работы**: Дополнить анализатор этапом формирования внутренней формы представления программы (ПОЛИЗ) и реализовать алгоритм вычисления выражений.
### Вариант 1
В качестве внутренней формы представления используется **польская инверсная запись (ПОЛИЗ)**.
